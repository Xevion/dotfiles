---
name: kotlin-expert
description: Expert in Kotlin programming language. Use for writing idiomatic Kotlin code, implementing coroutines, refactoring Java to Kotlin, and optimizing Kotlin performance.
model: sonnet
---
