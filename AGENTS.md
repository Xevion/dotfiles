...
1. **THIS FILE (`./AGENTS.md`)** - Project-level, chezmoi-specific instructions
...
- **Project-specific context** lives in this repository's `AGENTS.md` - chezmoi-specific instructions and restrictions
...
When working in this repository, you're reading both the global AGENTS.md (general development practices) and this AGENTS.md (chezmoi-specific guidelines). Project-specific CLAUDE.md files in other repositories take precedence over global guidelines.
...
| "Edit CLAUDE.md" | Location unclear | A) ./AGENTS.md (project)<br>B) home/dot_claude/CLAUDE.md.tmpl (user) |
...
- **Project-level**: `./AGENTS.md` (THIS file, chezmoi-specific instructions)
...
A. ./AGENTS.md (project-level, chezmoi-specific instructions)
...
- **File location questions** - Which CLAUDE.md/AGENTS.md file to edit (often multi-select if batch editing)
  - "Which file should I edit: project-level AGENTS.md or user-level home/dot_claude/CLAUDE.md.tmpl?"
